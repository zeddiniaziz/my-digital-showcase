...
const skills = {
  ...
  Concepts: ["MVC Architecture", "Database Modeling & Management", "System design-UML", "API Development", "Object-Relational Mapping (ORM)", "Object oriented programming (OOP)", "Asynchronous programming", "Testing"]
};
