...
const AboutSection = () => {
  return (
    <section id="about" className="py-24 px-0">
      <div className="container mx-auto border-t border-gray-300 py-4">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <div className="w-fit flex gap-2 mt-6 p-4 bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-lg border border-emerald-500/20">
              <Rocket className="w-6 h-6 md:w-5 md:h-5 text-emerald-400 self-start" />
