...
const ContactSection = () => {
  return (
    <section id="contact" className="py-24 px-0 bg-secondary/30">
      <div className="container mx-auto border-t border-gray-300 py-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            ...
            experienced developers, and help build amazing products. Let's
            ...
            <div className="space-y-4">
                ...
                >
                  <CardContent className="pt-6 flex items-start justify-between">
                    <div className="flex items-start gap-4">
                      <Mail className="w-6 h-6 text-black mt-1 transition-transform duration-500 group-hover:rotate-12" />
                      <div>
                        ...
                        <span className="text-muted-foreground group-hover:text-gray-900 transition-colors break-all">
              ...
              <Card className="bg-card border-border hover:border-gray-500 transition-colors group cursor-pointer">
                ...
                >
                  <CardContent className="pt-6 flex items-start justify-between">
                    <div className="flex items-start gap-4">
                      <Github className="w-6 h-6 text-black mt-1 transition-transform duration-500 group-hover:rotate-12" />
                      <div>
                        <h4 className="font-bold mb-1">
                          GitHub{" "}
                          <span className="text-xs ml-2 text-gray-500">
