  ...
  return (
    ...
    >
      <div className="container mx-auto text-center animate-fade-in">
        <Badge className="animate-bounce mb-6 bg-primary/10 text-primary border-primary/20 hover:bg-primary/20">
        ...
        <div className="flex gap-4 justify-center mb-12">
          <a
            ...
            className="text-muted-foreground hover:text-black transition-colors group"
          >
